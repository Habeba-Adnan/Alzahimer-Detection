...
image = Image.open(r'C:\Users\Habeba\.spyder-py3\picpython.png')
...
link3='https://share.streamlit.io/amrmohammmed/ad-project/PythonApplication1.py'
with st.sidebar:
    st.title("AD Project")
...
with datset:
    ...
    train_data=get_data(r'C:\Users\Habeba\.spyder-py3\p1.csv')
    st.write(train_data)
